...
export default function Escrow4() {
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-lg-9 col-md-12 mt-5 text-center">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-lg w-100 ">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-200 p-4 rounded-lg">
                                        <div className="flex gap-3 items-center cursor-pointer w-50" onClick={() => toggleDropdown('mandatory1', 'mandatory')}>
                        ...
                        <div className="flex justify-center gap-2">
                            ...
                            <Link to="/escrow5" className='saveNext'>
