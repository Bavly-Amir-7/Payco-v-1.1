                        ...
                        <div className="w-2/3">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="remember-and-forget d-flex mt-3 justify-between">
                                        <div>
                                        ...
                                        <div className="text-right">
                                            <Link to="/forget-password" className="text-sm text-gray-500 hover:text-red-700">
                                                Forgot Password?
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-4">
                                    <button type="submit" className="redBg w-full bg-red-600 text-white py-2 rounded">Login</button>
                                </div>
