...
import "./credit4.css";
import review from "./Code review-cuate 1.svg"
import SearchBar from '../../searchBar/searchBar';


export default function Credit4() {
                            ...
                            <div className="bg-white p-6 rounded-lg  w-100 ">
                                ...
                                <div className="flex items-center justify-center mt-10">
                                    <div className="text-center">
                                        ...
                                        The seller’s documents are under review, we will notify you once we finished <br /> reviewing it
                                        </p>
                                    </div>
                                </div>
