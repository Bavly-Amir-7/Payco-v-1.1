...
export default function Escrow7() {
                                    ...
                                    <div className="w-100">
                                        ...
                                        <div className="greyBg2 p-4 rounded-lg mb-4 flex flex-col md:flex-row items-start md:items-center">
                                            ...
                                            <div className="flex-1 text-start mb-2 md:mb-0">
                                                <div className="text-sm font-semibold md:text-lg">Proof of Shipping</div>                                                <div className="text-sm text-gray-500">Approved</div>
                                            </div>
                                            <div className="text-sm text-gray-500">Uploaded: 20/2/2024 1:05 PM</div>
                                        </div>
                                        {/* Approved Item */}
                                        <div className="greyBg2 p-4 rounded-lg mb-4 flex flex-col md:flex-row items-start md:items-center">
                                            <i className=" text-green-500 text-2xl mr-0 md:mr-4 mb-2 md:mb-0"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clipPath="url(#clip0_2795_49732)">
                                                    ...
                                                    <path d="M28.8197 16.8083C28.1877 16.6707 27.563 17.0717 27.4254 17.7041C27.3496 18.052 27.2581 18.4005 27.1531 18.7401C26.9621 19.3585 27.3085 20.0146 27.9268 20.2057C28.0421 20.2413 28.1585 20.2582 28.2732 20.2582C28.7735 20.2582 29.2369 19.9351 29.3924 19.4319C29.517 19.0289 29.6256 18.6153 29.7155 18.2026C29.8531 17.5703 29.4521 16.946 28.8197 16.8083Z" fill="#FFB930" />
                                        ...
                                        <p style={{ width: "90%" }}>You’re step away to transfer your money from escrow please be patient once all got approved you’ll be automatically directed to the next step</p>
